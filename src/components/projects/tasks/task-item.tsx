...
export function TaskItem({ task, onClick }: TaskItemProps) {
  ...
  return (
    <div 
        className="group flex items-center gap-4 py-3 px-4 bg-background border border-border/40 rounded-lg hover:border-border/80 hover:shadow-sm transition-all duration-200 cursor-pointer"
